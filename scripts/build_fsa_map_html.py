  ...
  <div class="layout">
    <div class="map-card">
      ...
      <div class="legend">
        ...
        <div class="legend-note" id="legend-note">Colored by value on a smooth scale &mdash; every area gets its own shade, so nearby values look similar but rarely identical.</div>
      </div>
...
(function () {
  ...
  // disputes) instead of a different hue per lens — ColorBrewer's RdYlGn,
