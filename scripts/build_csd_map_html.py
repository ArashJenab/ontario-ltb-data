  ...
  <div class="layout">
    <div class="map-card">
      ...
      <div class="legend">
        ...
        <div class="legend-note" id="legend-note">Colored by rank (equal-count bins), not raw value &mdash; a few extreme municipalities no longer wash out the rest.</div>
      </div>
...
(function () {
  ...
  // groups, so two nearby-but-different areas get visibly different shades
  // instead of identical ones. Uses a sqrt transform, not linear, for the
  // same right-skew reason quantile bins exist.
