...
<div class="page">
  ...
  <div>
    ...
    <p class="dek">Landlord and Tenant Board applications rolled up from postal FSA (Forward Sortation Area,
       the first 3 characters of a postal code) to municipality, normalized against
       resident population. Toggle between raw volume and per-10,000-resident rates, and between landlord-filed and
       tenant-filed cases: hover any area for the full breakdown. Prefer postal codes?
  ...
  <footer>
    ...
    areas; per-10,000 rates get noisy for small-population municipalities built from very few FSAs, so treat
...
(function () {
  ...
  // Uses a sqrt transform, not linear, for the same right-skew reason noted
  // on the FSA map.
